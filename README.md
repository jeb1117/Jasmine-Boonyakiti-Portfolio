...
- Understand the concepts and techinques of object-oriented software design
...
### 2. [Movie Database](https://github.com/jeb1117/Jasmine-Boonyakiti-Portfolio/tree/master/movie_database)
...
**Computer Science Learning Goals:**
- Aquire significant project experience working individually 
...
### 4. [Shaded Sphere](https://github.com/jeb1117/Jasmine-Boonyakiti-Portfolio/tree/master/Lab6)
...
This project represents the Computer Science program goals because it uses collaboration with a partner to get the project done. This project was probably one of my favorite ones since we actually got to see what the outcome of our hard work. It also promoted that we had to think critically on how to get this image to render correctly with the right colors, making sure the buttons work properly, and that both algorithms were done correctly. Plus we got a little creative on the colors so that it wasn't just one color but one color fading into another. 

### 5. [Sleeping TA](https://github.com/jeb1117/Jasmine-Boonyakiti-Portfolio/tree/master/sleeping_ta)
...
This project has taught me a lot in the sense that there is always room for improvement. There were a lot of rocky moments but I wouldn't change it for one second because I learned so much from this project. The first thing I learned was how to use Vulkan and C++ together to create objects on the scene with the shadow. Then I had taken that scene and had a fps tracker on the scene to track how much each algorithm had cost. For the College Wide Learning goals, I believe that this project was a lot of critical thinking and understanding how each algorithm works. Not only did I need to know how it works but I needed to be able to explain what each algorithm does. 


### 7. [Ethics of Insurance Companies Using AI](https://docs.google.com/document/d/1TxQRcq8xqp3jET-kVs8KNc_zA-bQYOePKTtyxmyIzeU/edit)

**College-Wide Learning Goals:**
- Global Responsibility
- Critical Thinking 

I worked on this paper for my Artificial Intelligence (CMPT 301) class at Westminster College. In this paper, I had to write about how AI has affected some of the ethical decisions within todays world. For this topic, I chose insurance companies and how they use AI to actually change people's insurance rates based on certain qualifications. 

I chose to include this paper because I believe that this paper demonstrates the global responsibility and critical thinking aspect of the College Wide Learning Goals. Ethics has been one of the more recent topics when it comes to AI. Now with the advancement in AI algorithms and the creation of robots that mimic human behavior, there have been certain ethical conversations when it comes to using this technology. This assignment helped me gain an idea of how ethical it is for insurance companies to actually use AI to be able to increase your life insurance prorate or decrease it based on fitbit information for example. This goes back to the whole privacy of people's information and what companies can and cannot do. Ultimately, this topic and paper gave me a better understanding on how people determine what is ethical in terms of using AI algorithms to better their companies and improve the quality of their insurance rates.

<object data="https://github.com/jeb1117/Jasmine-Boonyakiti-Portfolio/blob/master/Jasmine%20Boonyakiti%20Resume-1.pdf" type="application/pdf" width="700px" height="700px">
    <embed src="https://github.com/jeb1117/Jasmine-Boonyakiti-Portfolio/blob/master/Jasmine%20Boonyakiti%20Resume-1.pdf">
        <p>This browser does not support PDFs. Please download the PDF to view it: <a href="https://github.com/jeb1117/Jasmine-Boonyakiti-Portfolio/blob/master/Jasmine%20Boonyakiti%20Resume-1.pdf">Download PDF</a>.</p>
    </embed>
</object>
